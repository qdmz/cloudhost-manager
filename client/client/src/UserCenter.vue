      ...
      <a-col :span="18">
        ...
        <a-card v-if="currentKey === 'settings'" title="系统设置">
          <a-list>
            <a-list-item>
              <a>修改密码</a>
              <a-button size="small" @click="currentKey = 'password'">前往</a-button>
            </a-list-item>
            <a-list-item>
              <a>实名认证</a>
              <a-button size="small" @click="currentKey = 'auth'">前往</a-button>
            </a-list-item>
          </a-list>
        </a-card>
      </a-col>
...
import { UserOutlined, LockOutlined, VerifyOutlined, BankOutlined, SettingOutlined } from '@ant-design/icons-vue'
